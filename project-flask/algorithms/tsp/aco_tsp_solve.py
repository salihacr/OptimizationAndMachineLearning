        ...
        for t in range(self.iteration):
            for i in range(self.ant_size):
                ...
                for j in range(1, self.len_cities):
                    ...
                    probability = np.power(pheromone_amount[end_city, :], self.alpha) * np.power(distance[end_city, :], self.beta)
                ...
                for j in range(self.len_cities):
                    pos1 = route[j]
                    pos2 = route[j+1]
                    pheromone_amount[pos1, pos2] = pheromone_amount[pos1, pos2] + Q / cost[i]
